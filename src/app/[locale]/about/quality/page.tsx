    ...
    <div>
      ...
      <div className="relative w-full h-64 md:h-80 bg-gray-900 overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <h2 className="text-3xl md:text-4xl font-bold text-white">{t('qcProfile')}</h2>
        </div>
      </div>
      ...
      <div className="bg-white border-b">
        <div className="max-w-7xl mx-auto px-4 py-3">
          <div className="flex items-center gap-2 text-sm text-gray-500">
            ...
            <span className="text-gray-900 font-medium">{companyInfo.name} {t('qcProfile')}</span>
          </div>
        </div>
      </div>
          ...
          <aside className="hidden lg:block w-64 flex-shrink-0">
            <div className="bg-white rounded-lg shadow-sm border sticky top-24">
              ...
              <nav className="py-2">
                ...
                <Link href={`/${locale}/about/certificate`} className="block px-4 py-2.5 text-sm text-gray-700 hover:bg-gray-50 transition">
                  {t('certifications')}
                </Link>
                <Link href={`/${locale}/about/quality`} className="block px-4 py-2.5 text-sm bg-red-50 text-brand-red font-semibold border-r-2 border-brand-red">
                  {t('qcProfile')}
                </Link>
              </nav>
            </div>
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="space-y-6">
              <div className="bg-white border rounded-lg p-6 flex items-start gap-4 hover:shadow-md transition">
                ...
                <div>
                  <h3 className="font-semibold text-gray-900">Incoming Material Inspection</h3>
                  <p className="text-sm text-gray-500 mt-1">
                    All raw materials and components are thoroughly inspected upon arrival to ensure they meet our strict quality standards.
                  </p>
                </div>
              </div>
              <div className="bg-white border rounded-lg p-6 flex items-start gap-4 hover:shadow-md transition">
                ...
                <div>
                  <h3 className="font-semibold text-gray-900">In-Process Quality Control</h3>
                  <p className="text-sm text-gray-500 mt-1">
                    Continuous monitoring and inspection throughout the manufacturing process with multiple checkpoints.
                  </p>
                </div>
              </div>
              <div className="bg-white border rounded-lg p-6 flex items-start gap-4 hover:shadow-md transition">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500 mt-1">
                    Each hydraulic component undergoes pressure testing, flow rate verification, and durability assessment before shipment.
                  </p>
                </div>
              </div>
              <div className="bg-white border rounded-lg p-6 flex items-start gap-4 hover:shadow-md transition">
                ...
                <div>
                  <h3 className="font-semibold text-gray-900">Final Inspection & Packaging</h3>
                  <p className="text-sm text-gray-500 mt-1">
                    Complete final inspection with detailed quality reports. Products are carefully packaged to prevent damage during transit.
                  </p>
                </div>
              </div>
            </div>
